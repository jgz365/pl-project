...
{
    partial class UC_ConfirmArchive
    {
        ...
        private void InitializeComponent()
        {
            ...
            // ── Icon circle — amber bg, drawn as CIRCLE via Paint ─────────────
            // Size is SQUARE so the ellipse paint produces a perfect circle
            pnlIconOuter.BackColor = System.Drawing.Color.FromArgb(254, 243, 199); // amber-100
            pnlIconOuter.Location = new System.Drawing.Point(180, 34);
            pnlIconOuter.Name = "pnlIconOuter";
            pnlIconOuter.Size = new System.Drawing.Size(100, 100); // equal W and H = circle
            pnlIconOuter.TabIndex = 0;
            pnlIconOuter.Paint += pnlIconOuter_Paint;  // named handler — no lambda
            pnlIconOuter.Controls.Add(lblIconGlyph);

            // The label sits INSIDE the panel, Dock=Fill, transparent bg
            // so the circle paint shows through
            lblIconGlyph.BackColor = System.Drawing.Color.Transparent;
            lblIconGlyph.Font = new System.Drawing.Font("Segoe UI Emoji", 26f);
            lblIconGlyph.ForeColor = System.Drawing.Color.FromArgb(217, 119, 6); // amber-600
            ...
            lblSubText.Text = "This user will be moved to the Archive List\nand lose system access.";
            ...
            // ── Confirm button — amber fill ───────────────────────────────────
            btnConfirm.BorderRadius = 10;
            btnConfirm.FillColor = System.Drawing.Color.FromArgb(217, 119, 6);
        ...
        // (panel is 100×100 so ellipse = circle)
        private void pnlIconOuter_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
        {
            e.Graphics.SmoothingMode = System.Drawing.Drawing2D.SmoothingMode.AntiAlias;
            // Clear rectangle background first so corners are transparent
            e.Graphics.Clear(pnlCard.FillColor);
