...
namespace customer_kiosk
{
    public partial class ck : Form
    {
        ...
        {
            // Look for images in the project folder first
            ...
            products.Add(new Product
            {
                ...
                Displacement = "98cc",
                Price = 494000,
                ImagePath = Path.Combine(imagesPath, "honda_dream_d.jpeg")
            });
            ...
            products.Add(new Product
            {
                ...
                Displacement = "150cc",
                Price = 150000,
                ImagePath = Path.Combine(imagesPath, "honda_cb150r.jpg")
            });
            ...
            products.Add(new Product
            {
                ...
                Displacement = "155cc",
                Price = 185000,
                ImagePath = Path.Combine(imagesPath, "yamaha_r15.jpg")
            });
            ...
            products.Add(new Product
            {
                ...
                Displacement = "125cc",
                Price = 120000,
                ImagePath = Path.Combine(imagesPath, "suzuki_burgman.jpg")
            });
            ...
            products.Add(new Product
            {
                ...
                Displacement = "110cc",
                Price = 95000,
                ImagePath = Path.Combine(imagesPath, "kawasaki_barako.jpg")
            });
            ...
            products.Add(new Product
            {
                ...
                Displacement = "125cc",
                Price = 78000,
                ImagePath = Path.Combine(imagesPath, "honda_click_125i.jpg")
            });
            ...
            products.Add(new Product
            {
                ...
                Displacement = "150cc",
                Price = 95000,
                ImagePath = Path.Combine(imagesPath, "suzuki_gixxer_150.jpg")
            });
            ...
            products.Add(new Product
            {
                ...
                Displacement = "125cc",
                Price = 75000,
                ImagePath = Path.Combine(imagesPath, "honda_xrm_125.jpg")
            });
            ...
            products.Add(new Product
            {
                ...
                Displacement = "399cc",
                Price = 315000,
                ImagePath = Path.Combine(imagesPath, "kawasaki_ninja_400.jpg")
            });
            ...
            products.Add(new Product
            {
                ...
                Displacement = "155cc",
                Price = 150000,
                ImagePath = Path.Combine(imagesPath, "yamaha_nmax.jpg")
            });
            ...
            products.Add(new Product
            {
                ...
                Displacement = "175cc",
                Price = 130000,
                ImagePath = Path.Combine(imagesPath, "kawasaki_w175.jpg")
            });
            ...
            products.Add(new Product
            {
                ...
                Displacement = "150cc",
                Price = 110000,
                ImagePath = Path.Combine(imagesPath, "suzuki_raider_r150.jpg")
            });
        }
        ...
        private Guna.UI2.WinForms.Guna2ShadowPanel CreateProductTile(Product product)
        {
            ...
            {
                if (imageCache.ContainsKey(product.ImagePath))
                {
                    pictureBox.Image = imageCache[product.ImagePath];
                }
                else
                {
                    try
                    ...
                    {
                        pictureBox.Image = gpic1.Image; // fallback to placeholder
                    }
                }
            }
            else
            {
                pictureBox.Image = gpic1.Image; // placeholder
            }
