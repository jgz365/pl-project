...
{
    public partial class AdvancePaymentForm : UserControl
    {
        ...
        private readonly Color cardHoverBorderColor = Color.FromArgb(102, 217, 189);   // teal accent for Advance Payment
        ...
        private Guna2Panel CreateCustomerCard(CustomerSummary customer, int yPosition)
        {
            ...
            // ── CLICK: open AccountSummaryForm3 (Advance Payment version) ─────
        ...
        // ─────────────────────────────────────────────────────────────────────
        // Navigation: open AccountSummaryForm3
        // ─────────────────────────────────────────────────────────────────────
        private void OpenAccountSummary(CustomerSummary customer)
        {
            ...
            var summaryScreen = new AccountSummaryForm3(customer)   // ← Advance Payment version
            {
                Size = this.Size,
                Dock = DockStyle.Fill
            };
